...
function render() {
	...
	for (var i = 0; i < eyesNum; i++) {
		...
		if (mouseY<35) eyes[2].rotation.x = map_range(mouseY, 0, 35, 0, 0.25);
		...
		else eyes[4].rotation.x = map_range(mouseY, 60, window.innerHeight, 0.25, 1.14);

		if (mouseX<140) eyes[5].rotation.y = map_range(mouseX, 0, 140, -0.2, 0.25);
		else eyes[5].rotation.y = map_range(mouseX, 140, window.innerWidth, 0.25, 1.14);
		if (mouseY<35) eyes[5].rotation.x = map_range(mouseY, 0, 35, 0, 0.25);
		else eyes[5].rotation.x = map_range(mouseY, 60, window.innerHeight, 0.25, 1.14);

		if (mouseX<140) eyes[6].rotation.y = map_range(mouseX, 0, 140, -0.2, 0.25);
		else eyes[6].rotation.y = map_range(mouseX, 140, window.innerWidth, 0.25, 1.14);
		if (mouseY<35) eyes[6].rotation.x = map_range(mouseY, 0, 35, 0, 0.25);
		else eyes[6].rotation.x = map_range(mouseY, 35, window.innerHeight, 0.25, 1.14);

		if (mouseX<140) eyes[7].rotation.y = map_range(mouseX, 0, 140, -0.2, 0.25);
		else eyes[7].rotation.y = map_range(mouseX, 140, window.innerWidth, 0.25, 1.14);
		if (mouseY<35) eyes[7].rotation.x = map_range(mouseY, 0, 35, 0, 0.25);
		else eyes[7].rotation.x = map_range(mouseY, 35, window.innerHeight, 0.25, 1.14);
  }
