...
function init() {
  ...
  // modify UVs to accommodate MatCap texture
	...
	for (var i = 0; i < eyesNum; i++) {
		...
		xPos[i] = Math.random() * 1000 - 50;
		yPos[i] = Math.random() * 1000 - 50;
		...
		xPosMap[i] = map_range(xPos[i], -100, 100, 0, window.innerWidth);
		yPosMap[i] = map_range(yPos[i], -100, 100, 0, window.innerHeight);
